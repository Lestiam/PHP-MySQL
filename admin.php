...
<main>
    ...
    <section class="container-table">
        <table>
            ...
            <tbody>
            <?php foreach ($produtos as $produto): //todo o bloco abaixo envolvido vai se repetir?>
                <tr>
                    ...
                    <td>
                        <form action="excluir-produto.php" method="post" ><!-- com o method="post", o sistema não envia os dados mais atraves da URL mas sim, atraves do corpo da requisição, ou seja, é uma forma mais segura -->
                            ...
                            <input type="submit" class="botao-excluir" value="Excluir" > <!-- O submit transforma o botão de excluir em algo que "pega" a requisição ao clicarmos nele -->
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
