...
<main>
    ...
    <section class="container-form">
        <form method="post" enctype="multipart/form-data">
            ...
            <!-- quando passamos para o value algum texto, este texto já vai vir settado por padrão e nós podemos passar para ele, os dados do banco -->

            <div class="container-radio">
                <div>
                    <label for="cafe">Café</label>
                    <input type="radio" id="cafe" name="tipo"
                           value="Café" <?= $produto->getTipo() == "Café" ? "checked" : ""//se o tipo for café, marca, se não, não marca  ?>>
                </div>
                <div>
                    <label for="almoco">Almoço</label>
                    <input type="radio" id="almoco" name="tipo"
                           value="Almoço" <?= $produto->getTipo() == "Almoço" ? "checked" : "" ?>>
                </div>
            </div>

            <label for="descricao">Descrição</label>
            <input type="text" id="descricao" name="descricao" value="<?= $produto->getDescricao() ?>"
                   placeholder="Digite uma descrição" required>

            <label for="preco">Preço</label>
            <input type="text" id="preco" name="preco" value="<?= number_format($produto->getPreco(), 2) ?>"
                   placeholder="Digite uma descrição" required>
